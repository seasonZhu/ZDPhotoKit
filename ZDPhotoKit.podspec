#
#  Be sure to run `pod spec lint ZDPhotoKit.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/seasonZhu/ZDPhotoKit.git", :tag => "#{s.version}" }
  ...
  s.source_files  = "ZDPhotoKitDemo/ZDPhotoKitDemo/ZDPhotoKit/*.{swift}"
