...
class ZDPhotoCameraController: UIViewController {
    ...
    private lazy var naviBar: ZDPhotoNaviBar = {
        ...
        let image = UIImage(named: "camera_overturn_white")?.withRenderingMode(.alwaysOriginal)
        naviBar.setTitle("")
    ...
    private lazy var deleteButton: UIButton = {
        ...
        button.alpha = 0
        button.setImage(UIImage(named: "video_delete_dustbin_white"), for: .normal)
    ...
    private lazy var nextButton: UIButton = {
        let button = UIButton(frame: recordButton.frame)
        button.alpha = 0
        button.setImage(UIImage(named: "video_next_button_white"), for: .normal)
